  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 py-10">
      <div className="w-full max-w-lg p-6 bg-white shadow-xl rounded-lg">
        <h2 className="text-2xl font-semibold text-center text-cyan-700 mb-5">Comment Section</h2>
        ...
        <button
          ...
          className="w-full bg-cyan-700 text-zinc-100 p-3 rounded-md hover:bg-blue-600 transition-all"
        >
          Post Comment
        </button>
      </div>
      ...
      <div className="w-full max-w-lg mt-10">
        <h3 className="text-xl font-semibold text-center text-cyan-700 mb-4">Comments</h3>
